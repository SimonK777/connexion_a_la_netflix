...
if(!empty($_POST['email']) && !empty($_POST['password']) && !empty($_POST['password_two'])){
	...
	// TEST SI PASSWORD IDENTIQUE
	if($password != $password_two) {
		header('location: inscription.php?error=1&message=Vos mots depasses ne sont pas identiques');
		exit();
	}
...
while($email_verification = $req->fetch()) {
 ...
 // ENVOI DE LA REQUETE DE CREATION UTILISATEUR DANS LA DB
